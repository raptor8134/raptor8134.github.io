...
window.SITE_DATA={
  ...
  projects:[
    {id:"uhv-deposition",index:"002",title:"Multi-Source UHV Deposition System with Thermally Stabilized Thickness Monitoring",year:"2026",category:"semiconductor",
     ...
     meta:[{key:"Scope",value:`Senior design project, sponsored by [LAB NAME], continued under a summer research fellowship`},{key:"Role",value:`Sole technical contributor`}],
     body:[
      {list:{title:"At a glance",items:[
      ...
      {lead:`The cooling loop absorbs roughly twice the radiant load at the same crystal temperature.`,p:`Uncooled, the crystal climbed to 65 °C and stopped stabilizing entirely — past the linear region and past the point where the measurement means anything. Cooled, the system holds equivalent crystal temperature at double the input wattage.`},
      {lead:`The bridge is operating in steady-state conduction, not storing heat.`,p:`I computed power through the braid from the measured ΔT and its known length, cross-section, and conductivity, and confirmed it matched the applied load. The ΔT across the bridge widened from 5 °C to 20 °C across the power sweep, consistent with conduction-limited transport and no saturation.`},
      {note:{tone:"note",title:`Pending`,children:`Calculations to be inserted.`}},
      ...
      {note:{tone:"note",title:`Pending`,children:`Fit and residuals to be inserted.`}},
    ...
    {id:"filament-winder",index:"001",title:"Filament Winding Machine and Non-Cylindrical Toolpath Generator",year:"2025",category:"aerospace",
     ...
     meta:[{key:"Scope",value:`Independent project within [ROCKETRY ORG], year 2`},{key:"Role",value:`Sole contributor`}],
     body:[
      {list:{title:"At a glance",items:[
  ...
  writing:[],
  cv:[
    {key:"Jan 2026 – Present",role:"Researcher (MEMENCYS Fellowship)",org:"Dr. Ludwig Bartels Lab — Riverside, CA"},
    {key:"Oct 2023 – June 2026",role:"Airframe Lead",org:"Highlander Space Program — Riverside, CA"},
    {key:"June 2025 – Sept 2025",role:"Manufacturing Engineering Intern",org:"Woodward HRT — Santa Clarita, CA"},
    {key:"June 2024 – Sept 2024",role:"Machinist Intern",org:"S and S Machine — Roseville, CA"}
  ],
  backdrop:["01-d7d18ab2.jpg","02-a61e2612.jpg","03-1af1afef.jpg","04-eaeb2628.jpg","05-d3c4451a.png","06-a9a1f7e4.png","07-a8b942b2.png","08-870733e7.jpg","09-9990a8d7.jpg","10-a6e1e81a.jpg","11-88140b17.png","12-d4048632.png","13-a2d803ba.png","14-5a651c54.png"]
    .map(f=>"../../uploads/micrographs/"+f)
};
